...
function App() {
  const init = [
    ...
    },
    {
      ...
      rating: 7.8,
      trailer: "//www.youtube.com/embed/kVrqfYjkTdQ",
    },
    {
      id: 5,
      ...
      rating: 9.3,
      trailer: "//www.youtube.com/embed/NmzuHjWmXOc",
    },
    {
      id: 6,
      ...
      rating: 9.0,
      trailer: "//www.youtube.com/embed/EXeTwQWrcwY",
    },
  ];
  const [filter, setFilter] = useState(false);
  const [movies, setMovies] = useState(init);
  const handleFilter = () => {
    setFilter(true);
  };
  ...
  return (
    <>
      <Routes>
        ...
        />
        <Route exact path="/:id" element={<MovieDesc movies={movies} />} />
      </Routes>
    </>
  );
}
